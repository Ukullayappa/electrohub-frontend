...
// ⚠️ REMOVED the 401 → window.location.href="/login" redirect
// That was the infinite loop cause:
// getMe() returns 401 (normal when not logged in)
// → interceptor fires window.location.href="/login"
// → page reloads → getMe() runs again → 401 → reload → forever
